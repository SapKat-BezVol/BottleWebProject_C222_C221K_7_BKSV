...
<div class="tab-content" style="margin-left: 20px; margin-right: 20px">
    ...
    <!-- Вариант 3 -->
    <div role="tabpanel" class="tab-pane fade" id="variant3" style="line-height:1.7;">
        <div class="row">
            <div class="col-md-12">
                ...
                <section class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <ul class="mb-1">
                            ...
                            <li>При необходимости коэффициент корреляции:
                                \[
                                r_{ij}=\frac{\sum_k(x_{ki}-\bar{x}_i)(x_{kj}-\bar{x}_j)}
                                {\sqrt{\sum_k(x_{ki}-\bar{x}_i)^2\sum_k(x_{kj}-\bar{x}_j)^2}}
                                \]
                            </li>
                        </ul>
                        <h4>Особенности</h4>
