   ...
   <div class="tab-pane fade" id="variant2" role="tabpanel" aria-labelledby="variant2-tab" tabindex="0">
      <div class="row">
         <div class="col-md-12">
            ...
            <h4>Пример ручного расчёта</h4>
            <p>Допустим, есть две переменные:</p>
            ...
            <p>Подставим значения в формулу Пирсона:</p>
            <p style="text-align:center;font-size:120%;">
               \[
               r = \frac{(1 - 2.5)(2 - 4.75) + (2 - 2.5)(3 - 4.75) + (3 - 2.5)(6 - 4.75) + (4 - 2.5)(8 - 4.75)}
               {\sqrt{(1 - 2.5)^2 + (2 - 2.5)^2 + (3 - 2.5)^2 + (4 - 2.5)^2} \cdot \sqrt{(2 - 4.75)^2 + (3 - 4.75)^2 + (6 - 4.75)^2 + (8 - 4.75)^2}}
               \]
            </p>
            <p>После вычислений получаем значение:</p>
            <p style="text-align:center;font-size:130%;"><strong>\( r \approx 0.98 \)</strong></p>
            <p>Это означает <strong>очень сильную положительную линейную зависимость</strong> между переменными X и Y.</p>
