...
* **Страница Вариант 4 (Володин):**
  Реализовано обучение простой модели (например, линейной регрессии) на предоставленных данных. Пользователь выбирает целевую колонку и параметры модели. После обучения отображаются прогноз. Можно предложить загрузку новых данных для прогнозирования.
