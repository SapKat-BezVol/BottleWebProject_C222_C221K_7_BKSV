...
* **Страница Вариант 2 (Катаван):**
  На странице создаётся корреляционная матрица для всех или выбранных числовых колонок. Результат выводится в табличном виде и в виде тепловой карты (heatmap) с цветовой шкалой. 
